...
public class CambiarContra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtpass1 = (EditText) findViewById(R.id.txtcontra1);
        txtpass2 = (EditText) findViewById(R.id.txtcontra2);
    }
    ...
    public void cambiar(View view){
        ...
        if (txtpass1.getText().toString().isEmpty()) {
            ...
            okhttp3.Request request = new okhttp3.Request.Builder().url("https://juansuarezz-servidorflask.zeet.app/CambiarM").post(body).build();
